...
public class RateCardServiceTests
{
    ...
    public async Task Resolve_returns_rate_for_project_and_role()
    {
        ...
        Assert.Equal(150m, await _rateCards.ResolveAsync(_project.Id, null, _developerRole.Id));
        Assert.Null(await _rateCards.ResolveAsync(_project.Id, null, _adminRole.Id));
    }
