...
public class TimeEntry
{
    ...
    /// <summary>The project module this entry belongs to. Required on projects with live
    /// modules; null on non-modular projects and on entries that predate the project's
    /// modules (the "unassigned" bucket). Fixed at creation — the grid cell's identity.</summary>
