...
/// employee's own timesheet grid). Carries the project's dates and status so the grid can hide
/// projects outside the viewed window and projects that no longer accept time.</summary>
public record EmployeeAssignment(
    ProjectAssignment Assignment, string ProjectCode, string ProjectName, string ClientName,
    DateOnly? ProjectStartDate = null, DateOnly? ProjectEndDate = null,
